...
<!-- 					<li class="nav-item"><a class="nav-link" -->
<%-- 						href="${contextRoot}/dic/index">後臺測試</a></li> --%>
				<li class="nav-item"><a class="nav-link " href="${contextRoot}/Movies/search">搜尋電影</a></li>
					<li class="nav-item"><a class="nav-link " href="${contextRoot}/login">立即訂票</a></li>
<%-- 					<li class="nav-item"><a class="nav-link " href="${contextRoot}/login">購物商城</a></li> --%>
					<li class="nav-item"><a class="nav-link " href="${contextRoot}/login">討論區</a></li>
					<li class="nav-item"><a class="nav-link " href="${contextRoot}/login">會員中心</a></li>
					<li class="nav-item"><a class="nav-link " href="${contextRoot}/dic/userPostHistory">發文記錄及編輯</a></li> 
				</ul>

				<div class="d-flex" role="search">
					<input class="form-control me-2" type="search" placeholder="搜尋文章標題"
