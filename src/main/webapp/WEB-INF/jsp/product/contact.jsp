    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <form:form class="form-control" modelAttribute="orderdetail"
                     method="post" action="${contextRoot}/contact/createOrderdetail" >
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <form:input path="userEmail" class="form-control" id="email" name="email" placeholder=""/>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12">
